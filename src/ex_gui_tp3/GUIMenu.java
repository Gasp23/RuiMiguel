...
public class GUIMenu extends JFrame{
    ...
    public GUIMenu(Projeto p,GUI gui){
        ...
        btnGenerate = new JButton("Generate Voyage");
        btnGenerate.addActionListener(new ButtonGenerateListener());
    ...
    private void GenerateVoyage(){
        p.algoritmo(p.getUser());
        GUIVoyages voyages = new GUIVoyages(p, gui, this);
        voyages.setVisible(true);
        this.setVisible(false);
    }
    
    private class ButtonGenerateListener implements ActionListener{

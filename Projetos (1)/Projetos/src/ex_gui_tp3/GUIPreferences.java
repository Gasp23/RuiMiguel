        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(e.getSource()==addP){
                if(i!=-1){
                    ...
                    p.SaveToObjectFile();
                    int option = JOptionPane.showConfirmDialog(null, "Quer selecionar pontos de interesse deste local?", "Confirmar", JOptionPane.YES_NO_OPTION);
                    if(option == 0){
                      GUIPointsOfInterest guiPointsOfInterest = new GUIPointsOfInterest(p,GUIPreferences.this,i);
                      guiPointsOfInterest.setVisible(true);
                      GUIPreferences.this.setVisible(false);
                    }
                ...
                if(i!=-1){
                    ...
                    for(int j=0;j<p.getLocais().get(i).getPontosDeInteresse().size();j++){
                        p.getUser().getNotInteresses().add(p.getLocais().get(i).getPontosDeInteresse().get(j));
                    }
